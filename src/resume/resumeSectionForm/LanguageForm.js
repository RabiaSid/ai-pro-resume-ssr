...
const LanguageForm = (props) => {
  ...
  useEffect(() => {
    const filteredLangs = languagesList?.filter(
      (lang) => !userLanguagesList.some((userLang) => userLang.id === lang.id)
    );
            ...
            <Controller
              ...
              render={({ field }) => (
                <Autocomplete
                  ...
                  id="language_id"
                  disableClearable
                  options={field.value ? languagesList : filteredLanguagesList}
            ...
            <Controller
              ...
              render={({ field }) => (
                <FormControl fullWidth error={!!errors.level_id}>
                  ...
                  {errors.level_id && (
                    <FormHelperText>{errors.level_id.message}</FormHelperText>
                  )}
                </FormControl>
              )}
            />
