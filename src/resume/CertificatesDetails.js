...
const Header = ({ isOpen }) => {
  ...
  const edit = (id) => {
    if (isExampleTrue === "true") {
      window.location.href =
        global.localPath + "resume/certificates/" + id + "?example=true";
    } else {
      window.location.href = global.localPath + "resume/certificates/" + id;
    }
  };
        ...
        axios
          ...
          .then((data) => {
            if (data) {
              ...
              axios
                .get(global.baseurl + "/certificate/" + profile_id, { headers })
                .then((data) => {
                  if (data) {
                        ...
                        >
                          ...
                          {personal_info.map(
                            (personal_info, index_personal_info) => (
                              <Draggable
                                key={personal_info.title}
                                draggableId={personal_info.title}
