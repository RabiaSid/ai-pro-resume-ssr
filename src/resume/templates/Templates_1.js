      ...
      {check_loading === 0 ||
        ...
        >
          ...
          >
              ...
              >
                <b>
                  {props.runtime_linkedin
                    ? "Linkedin : (" + props.runtime_linkedin + ")"
            ...
            <hr className="border" style={{ borderColor: pen_color_def }} />
            <p
              className={
                paragraph_font_style
                  ? paragraph_font_style + " p-1 text-center"
                  : "font_2" + " p-1 text-center"
              }
              style={{
                color: "black",
                fontSize: paragraph_font_size
            ...
            >
              <i>
                ...
                {province
                  .filter((province) => province.id === personal_info.state_id)
                  .map((province) => (
                    <>{province?.name}, </>
                  ))}
                {countries
                  .filter(
                    (countries) => countries.id === personal_info.country_id
                  )
                  .map((country) => (
                    <>{country?.name}</>
                  ))}
            ...
            <div className="flex justify-start items-center flex-wrap px-10 py-4">
              <h1
                className={
                  heading_font_style
                    ? heading_font_style + " py-2 w-full underline"
                    : "font_1" + " py-2 w-full underline"
                }
                style={{
                  color: pen_color_def,
                  fontSize: heading_font_size
