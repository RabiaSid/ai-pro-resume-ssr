...
const Header = (props) => {
  ...
  return (
    <section
      id={"print-content-2_" + props.doc_id}
      style={{
        transform: scale,
        width: width + "%",
        ...
        >
          ...
          >
            ...
            >
              ...
              <div className="flex justify-center items-center flex-wrap w-[30%] text-center">
                <h1
                  className={
                    heading_font_style
              ...
              <div className="col-span-5 w-[50%]">
                <section className=" justify-center items-center py-10">
                  <div
                    className={
                      paragraph_font_style
                        ? paragraph_font_style +
