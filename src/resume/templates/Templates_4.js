...
// import { BiPencil,BiCamera } from 'react-icons/bi';
import {
  BiTrophy,
  BiCertification,
  BiCog,
...
const Header = (props) => {
  ...
  return (
    <section
      id={"print-content-4_" + props.doc_id}
      style={{
        transform: scale,
        width: width + "%",
      ...
      {check_loading === 0 ||
        ...
        >
          <div className="flex">
            {/* left Side Section */}
            <div
              className="sm:w-[250px] lg:w-[300px] h-auto"
              style={{ background: pen_color_def }}
            >
              <div
                className={
                  "cursor-pointer relative h-full sm:w-[250px] lg:w-[300px]"
                }
              >
                <div className="flex flex-wrap   text-white py-4 gap-4 sm:w-[250px] lg:w-[300px]">
                  <div
                    className={
                  ...
                  >
                    <div className="flex flex-wrap justify-center items-center">
                      <div className="hidden dd_menu4 absolute right-0">
                        <a
                          href={global.localPath + "resume/header/" + doc_uuid}
                        >
                          <BiPencil
                            size={30}
                      ...
                      <div className="flex items-center text-center w-full">
                        {personal_info.profile_image ? (
                          <img
                            ...
                            width={100}
                            height={100}
                            className="rounded-full m-auto w-[100px] h-[100px] shadow-lg border-2 border-[#111]"
                          />
                        ) : (
                          <div
                            className={
                              heading_font_style
                                ? heading_font_style +
                                " rounded-full w-[100px] h-[100px] m-auto flex justify-center items-center"
                                : "font_1" +
                                " rounded-full w-[100px] h-[100px] m-auto flex justify-center items-center"
                            }
                            style={{
                      ...
                      <div className="flex flex-col gap-4 py-4">
                        ...
                        <h1
                          className={
                            heading_font_style
                              ? heading_font_style +
                              " my-2 py-2 w-full flex items-center justify-center text-center bg-[red] shadow-lg"
                              : "font_1" +
                              " my-2 py-2 w-full flex items-center justify-center text-center bg-[red] shadow-lg"
                          }
                          style={{
                        ...
                        <div className="col-span-5 w-full">
                          <section className="justify-center items-center px-4">
                            ...
                            >
                              <div className="w-[30px] h-[30px] bg-white text-gray-700  rounded-full flex justify-center items-center">
                                <FaHome className="text-sm" />
                              </div>
                              <p className="pl-2 w-[90%] text-xs break-words">
                                ...
                                {cities
                                  .filter(
                                    (cities) =>
                                      cities.id === personal_info.city_id
                                  )
                                  .map((city) => (
                                    <>{city?.name}, </>
                                  ))}
                            ...
                            >
                              ...
                              <p className="pl-2  break-words text-xs w-[90%]">
                            ...
                            {personal_info.linkedin ? (
                              ...
                              >
                                ...
                                <p className="break-all pl-2 w-[90%] text-xs ">
                                      ...
                                      {languages && Number(languages.length) > 0
                                        ? languages.map(
                                          (languages, index_languages) => (
                                            ...
                                            >
                                              {Number(index_languages) ===
                                                0 ? (
                                                <h1
                                                  className={
                                                    heading_font_style
                                                      ? heading_font_style +
                                                      " my-2 py-2 w-full flex items-center justify-center text-center bg-[#acc646] shadow-lg"
                                                      : "font_1" +
                                                      " my-2 py-2 w-full flex items-center justify-center text-center bg-[#acc646] shadow-lg"
                                                  }
                                                  style={{
                                              ...
                                              <div
                                                className={
                                                  Number(props.formatting) ===
                                                    1
                                                    ? "dd_btn4 hover:bg-emerald-100 cursor-pointer relative w-full flex justify-center items-center flex-wrap px-2"
                                                    : ""
                                                }
                                              >
                                            ...
                                            <div className="flex justify-center items-center flex-wrap py-4">
                                              <h1
                                                className={
                                                  heading_font_style
                                                    ? heading_font_style +
                                                    " my-2 py-2 w-full flex items-center justify-center text-center bg-[#7ca3b6] shadow-lg"
                                                    : "font_1" +
                                                    " my-2 py-2 w-full flex items-center justify-center text-center bg-[#7ca3b6] shadow-lg"
                                                }
                                                style={{
                                            ...
                                            <div className="flex justify-center items-center flex-wrap  py-4">
                                              <h1
                                                className={
                                                  heading_font_style
                                                    ? heading_font_style +
                                                    " my-2 py-2 w-full flex items-center justify-center text-center bg-[#f79521] shadow-lg"
                                                    : "font_1" +
                                                    " my-2 py-2 w-full flex items-center justify-center text-center bg-[#f79521] shadow-lg"
                                                }
                                                style={{
            ...
            <div className="w-full py-4">
              ...
              {/* This section is objective section */}
                            ...
                            >
                              {(provided) => (
                                <li
                                  ...
                                  {...provided.draggableProps}
                                  {...provided.dragHandleProps}
                                  className="hover:bg-emerald-100 hover:cursor-grab w-full border-b border-b-slate-300 "
                                >
                                  {summary !== null ? (
                                    <>
                                      <div
                                      ...
                                      >
                                        ...
                                        <div className="flex justify-center items-center flex-wrap px-4 py-4">
                                          <div
                            ...
                            >
                              {(provided) => (
                                <li
                                  ...
                                  {...provided.draggableProps}
                                  {...provided.dragHandleProps}
                                  className="hover:bg-emerald-100 hover:cursor-grab border-b border-b-slate-300 w-full"
                                >
                                  {experiences &&
                                    ...
                                    ? experiences?.map(
                                      (experiences, index_experiences) => (
                                        <div
                                          ...
                                          className="flex justify-start items-center flex-wrap px-4 py-2"
                                        >
                                  ...
                                  {education && Number(education.length) !== 0
                                    ? education?.map(
                                      (education, index_education) => (
                                        <div
                                          key={index_education}
                                          className="flex justify-start items-center flex-wrap px-4 py-4"
                                        >
                                    ...
                                    ? certificate.map(
                                      (certificate, index_certificate) => (
                                        <div
                                          ...
                                          className="flex justify-center items-center flex-wrap px-4 py-4"
                                        >
              ...
              {digital_signature && digital_signature != "" ? (
                ...
                >
                  ...
                  <div className="flex justify-start items-center flex-wrap px-4 py-4">
