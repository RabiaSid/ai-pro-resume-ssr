    ...
    >
      ...
      >
        <div className="w-[35%]  flex flex-col gap-4 px-2 py-4 h-auto">
          {/* personal_info */}
          <div className="p-4 bg-[#024C43] rounded-xl theme13_default_bg_1 theme_bg_1 resume-section-content">
          ...
          <div className="p-4 bg-[#024C43] rounded-xl theme13_default_bg_1 theme_bg_1 flex-1">
            {/* technical skills */}
                  ...
                  <div className="pt-10" id="data_references">
                    <table className="mytable mb-2">
                      <tr>
                        ...
                        <td className="uppercase  Arial text_white pl-2 font-semibold data-font-name data-font-size-main-heading default-font-size-main-heading">
                          References
                        </td>
                      </tr>
                    </table>
          ...
          <div className="w-full flex justify-between  px-6">
            ...
            >
              ...
              <div className="w-[80%] text-center">
                <h1 className="theme13_default_fg_1 theme_fg_1 font-bold tracking-wider Arial data-font-name default-font-size-heading data-font-size-heading">
                  <span className="break-all">
                    {first_name ? first_name : "Your Name"}{" "}
                  </span>
                  {last_name ? last_name : ""}
                </h1>
                <p className="theme13_default_fg_2 theme_fg_2 data-font-name Arial data-font-size-sub-heading default-font-size-sub-heading ">
                  {job_title ? job_title : ""}
                </p>
              </div>
            </header>
          ...
          {summary ? (
            <div className="pt-5 mx-8" id="data_summary">
              <div className="resume-section-content">
                <div
                  className="Arial whitespace-pre-line text-sm text-justify text-[#000000] leading-[1.3] data-font-name data-font-size-desc-heading default-font-size-desc-heading"
                  dangerouslySetInnerHTML={{
                    __html: summary
                      ? summary
            ...
            <>
              <div className="pt-5 mx-8" id="data_experience">
                <table className="mytable ">
                  <tr>
                    <td className="relative">
                      <div className="absolute left-[-5px] top-[5px] w-[5px] h-6 theme13_default_bg_1 theme_bg_1 rounded-tl-md rounded-bl-md"></div>
                      <div className="absolute left-[-9px] top-[8px] w-[3px] h-4 theme13_default_bg_1 theme_bg_1  rounded-tl-md rounded-bl-md"></div>
                      <div className="w-8 h-8 rounded-md flex justify-center items-center theme13_default_bg_2 theme_bg_2">
