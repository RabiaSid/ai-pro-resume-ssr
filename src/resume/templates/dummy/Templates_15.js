    ...
    >
      <div className="chk_height main flex min-h-[1308px]  h-auto">
        <div className="w-[30%] h-auto theme6_default_bg_1 theme_bg_1">
          <div className=" mt-2 w-full" id="data_personal_info">
          ...
          {/* summary */}
          {summary ? (
            <div className="mx-6 mt-6 " id="data_summary">
          ...
          <div className="px-6 mt-6">
            ...
            <div className="mt-1" id="data_contacts">
              <SectionProfileInfo
                ...
                state={state}
                colorText={"text-[#111]"}
                colorIcon={"theme_fg_2 theme6_default_fg_2"}
          ...
          {resume_sections?.show_experience === 1 && (
            <>
              <div className="mt-6 mx-6" id="data_experience">
                <h2 className=" w-full font-semibold uppercase tracking-wider text-[#111] Arial data-font-name data-font-size-main-heading default-font-size-main-heading ">
                  Experience
                </h2>
                  ...
                  experiences?.map((exp, idx) => (
                    <section key={idx} className="mb-2  w-full">
                      <SectionExperience
                        countryId={country_id}
                        allCountries={allCountries}
                        colorPosition={"theme6_default_fg_2 theme_fg_2"}
                        colorDates={"tracking-wide italic"}
                        colorLocation={""}
                        variant={1}
                        data={exp}
                      />
            ...
            {education?.length > 0 ? (
              education?.map((edu, idx) => (
                <section key={idx} className="w-full">
                  <SectionEducation
                    countryId={country_id}
                    colorTitle={"theme6_default_fg_2 theme_fg_2"}
                    colorDates={"tracking-wide italic"}
                    colorLocation={""}
                  ...
                  {references?.length > 0 ? (
                    references?.map((ref, idx) => (
                      <section key={idx} className="w-full">
                        <SectionReferences
                          colorTitle={"text-[#111]"}
                          colorDesignation={"theme6_default_fg_2 theme_fg_2"}
