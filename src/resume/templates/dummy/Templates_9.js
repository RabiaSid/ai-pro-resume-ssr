          ...
          <div className="w-full flex flex-wrap justify-between items-start px-10">
            <header className="w-full my-6" id="data_personal_info">
              <div className="w-full text-center">
                ...
                <p className="theme8_default_fg_2 theme_fg_2 tracking-wider font-semibold data-font-name Arial data-font-size-main-heading default-font-size-main-heading ">
                  {job_title ? job_title : ""}
                </p>
              </div>
              {/* personal_info */}
            ...
            {summary ? (
              <section className="mt-4" id="data_summary">
                <table className="w-full  text-[#333] border-b-2 border-slate-300 py-0.5 mb-2 font-bold tracking-wide  Arial data-font-name data-font-size-heading default-font-size-heading">
                  <tr>
                    <td className="w-[40px]">
                      <FaUserTie className="theme8_default_fg_1 theme_fg_1" />
                    </td>
                    <td>Summary</td>
                  </tr>
                </table>
            ...
            {resume_sections?.show_experience === 1 && (
              <section className="mt-4 w-full" id="data_experience">
                <table className="w-full  text-[#333] border-b-2 border-slate-300 py-0.5 mb-2 font-bold tracking-wide  Arial data-font-name data-font-size-heading default-font-size-heading">
                  <tr>
                    <td className="w-[40px]">
                      <IoMdBriefcase className="theme8_default_fg_1 theme_fg_1" />
                    </td>
                    <td>Experience</td>
                  </tr>
                </table>
                  ...
                  experiences?.map((exp, idx) => (
                    <section key={idx} className="mb-2 w-full">
                      <SectionExperience
                        countryId={country_id}
                        allCountries={allCountries}
                        colorPosition={"theme8_default_fg_2 theme_fg_2"}
                        colorDates={
                          "theme8_default_fg_1 theme_fg_1 italic tracking-wide"
                        }
            ...
            <section className="mt-2 w-full" id="data_educations">
              <table className="w-full  text-[#333] border-b-2 border-slate-300 py-0.5 mb-2 font-bold tracking-wide  Arial data-font-name data-font-size-heading default-font-size-heading">
                <tr>
                  <td className="w-[40px]">
                    <FaUserGraduate className="theme8_default_fg_1 theme_fg_1" />
                  </td>
                  <td>Education</td>
                </tr>
              </table>
              ...
              {education?.length > 0 ? (
                education?.map((edu, idx) => (
                  <section key={idx} className="w-full">
                    <SectionEducation
                      countryId={country_id}
                      colorTitle={"theme8_default_fg_2 theme_fg_2"}
                      colorDates={
                        "theme8_default_fg_1 theme_fg_1 italic tracking-wide"
                      }
                      colorLocation={"text_black"}
                ...
                {awards?.length > 0 && (
                  <section className="mt-4" id="data_awards">
                    <table className="w-full  text-[#333] border-b-2 border-slate-300 py-0.5 mb-2 font-bold tracking-wide  Arial data-font-name data-font-size-heading default-font-size-heading">
                      <tr>
                        <td className="w-[40px]">
                          <FaTrophy className="theme8_default_fg_1 theme_fg_1" />
                        </td>
                ...
                {certificates?.length > 0 && (
                  <section className="mt-4" id="data_certifications">
                    <table className="w-full  text-[#333] border-b-2 border-slate-300 py-0.5 mb-2 font-bold tracking-wide  Arial data-font-name data-font-size-heading default-font-size-heading">
                      <tr>
                        <td className="w-[40px]">
                          <PiCertificateFill className="theme8_default_fg_1 theme_fg_1" />
                        </td>
                        <td>Certificates</td>
                      </tr>
                    </table>
            ...
            <section className=" w-full mt-4" id="data_technical_skills">
              <table className="w-full  text-[#333] border-b-2 border-slate-300 py-0.5 mb-2 font-bold tracking-wide  Arial data-font-name data-font-size-heading default-font-size-heading">
                <tr>
                  <td className="w-[40px]">
                    <BsFillPersonCheckFill className="theme8_default_fg_1 theme_fg_1" />
                  </td>
                ...
                {languages?.length > 0 && (
                  <section className="mt-4 w-full" id="data_languages">
                    <table className="w-full  text-[#333] border-b-2 border-slate-300 py-0.5 mb-2 font-bold tracking-wide  Arial data-font-name data-font-size-heading default-font-size-heading">
                      <tr>
                        <td className="w-[40px]">
                          <IoLanguageSharp className="theme8_default_fg_1 theme_fg_1" />
                        </td>
                        <td>Languages</td>
                      </tr>
                    </table>
                      ...
                      {languages?.length > 0 ? (
                        languages?.map((language, idx) => (
                          <SectionLanguages
                            ...
                            colorForeground={"theme8_default_bg_1 theme_bg_1"}
                            variant={6}
                            data={language}
                          />
                        ))
                  ...
                  .map((custom_section, idx) => (
                    <section className="mt-4 w-full">
                      <table className="w-full  text-[#333] border-b-2 border-slate-300 py-0.5 mb-2 font-bold tracking-wide  Arial data-font-name data-font-size-heading default-font-size-heading">
                        <tr>
                          <td className="w-[40px]">
                            <CgLoadbarDoc className="theme8_default_fg_1 theme_fg_1" />
                          </td>
                ...
                {references?.length > 0 && (
                  <section className="mt-4 w-full" id="data_references">
                    <table className="w-full  text-[#333] border-b-2 border-slate-300 py-0.5 mb-2 font-bold tracking-wide  Arial data-font-name data-font-size-heading default-font-size-heading">
                      <tr>
                        <td className="w-[40px]">
                          <VscReferences className="theme8_default_fg_1 theme_fg_1" />
                        </td>
                        <td>References</td>
                      </tr>
                    </table>
                    ...
                    {references?.length > 0 ? (
                      references?.map((ref, idx) => (
                        <section key={idx} className="w-full">
                          <SectionReferences
                            colorTitle={"theme8_default_fg_2 theme_fg_2"}
                            colorDesignation={"theme8_default_fg_2 theme_fg_2"}
                            colorLocation={"theme8_default_fg_1 theme_fg_1"}
