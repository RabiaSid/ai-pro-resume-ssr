    ...
    <>
      ...
      >
        ...
        <section className="flex  w-full flex-wrap">
          <div className="flex flex-col flex-1 w-[30%] border-r-2 border-black chk_height min-h-[1308px]">
            ...
            <div className="mt-6 mx-4" id="data_contacts">
              <table className="w-full text_black font-semibold tracking-wide mb-4   Arial data-font-name data-font-size-main-heading default-font-size-main-heading">
                <tr>
                  <td className="w-[45px]">
                    <div className="w-[40px] h-[40px] flex items-center justify-center rounded-full theme11_default_bg_1 theme_bg_1 text_white">
                      <TiContacts size={22} className="text_white" />
                    </div>
                  </td>
                  <td>Contact Info</td>
                </tr>
            ...
            <section className=" w-full mt-4 px-4" id="data_technical_skills">
              <table className="w-full text_black font-semibold tracking-wide mb-4   Arial data-font-name data-font-size-main-heading default-font-size-main-heading">
                <tr>
                  <td className="w-[45px]">
                    <div className="w-[40px] h-[40px] flex items-center justify-center rounded-full theme11_default_bg_1 theme_bg_1 text_white">
                      <BsFillPersonCheckFill size={22} className="text_white" />
                    </div>
                  </td>
                  ...
                  <section className="mt-4 mx-4" id="data_languages">
                    <table className="w-full text_black font-semibold tracking-wide mb-4   Arial data-font-name data-font-size-main-heading default-font-size-main-heading">
                      <tr>
                        <td className="w-[45px]">
                          <div className="w-[40px] h-[40px] flex items-center justify-center rounded-full theme11_default_bg_1 theme_bg_1 text_white">
                            <IoLanguageSharp size={22} className="text_white" />
                          </div>
                        </td>
                        <td>Languages</td>
                      </tr>
            ...
            <div className="">
              <header className="w-full my-6 pl-6" id="data_personal_info">
                <div className="w-full">
                  <h1 className="theme11_default_fg_2 theme_fg_2 Arial tracking-wider data-font-name default-font-size-super-heading data-font-size-super-heading">
                    ...
                    experiences?.map((exp, idx) => (
                      <section key={idx} className="mb-2 w-full">
                        <SectionExperience
                          ...
                          colorDates={
                            "theme11_default_fg_2 theme_fg_2  tracking-wide"
                          }
