...
const Header = (props) => {
  ...
  return (
    <section
      id={"print-content-9_" + props.doc_id}
      style={{
        transform: scale,
        width: width + "%",
      ...
      {check_loading === 0 ||
        ...
        >
          ...
          >
            <div className="flex flex-wrap justify-center items-center">
              <div className="hidden dd_menu4 absolute right-0">
                {/* <a href={global.localPath +'resume/header/'+doc_uuid}><BiPencil size={30} className='text-slate-900 hover:text-[#0072b1] p-1'/></a> */}
              ...
              <div className="flex items-center text-center w-[20%]">
                {personal_info.profile_image ? (
                  <img
                    ...
                    width={120}
                    height={120}
                    className="rounded-full m-auto w-[120px] h-[120px] shadow-lg border-2 border-[#111]"
                  />
                ) : (
                  <div
                    className={
                      heading_font_style
                        ? heading_font_style +
                        " rounded-full w-[120px] h-[120px] m-auto flex justify-center items-center"
                        : "font_1" +
                        " rounded-full w-[120px] h-[120px] m-auto flex justify-center items-center"
                    }
                    style={{
              ...
              <div className="flex justify-start items-center flex-wrap w-[80%]">
                <h1
                  className={
                    heading_font_style
                ...
                {summary !== null ? (
                  <div
                    className={
                      Number(props.formatting) === 1 ? "dd_btn4 relative" : ""
                    }
                  >
                    <div className="hidden dd_menu4 absolute right-0 items-start">
                      <BiMove
                        size={30}
                        className="text-slate-900 hover:text-[#0072b1] p-1"
                      />
                      <a
                        href={global.localPath + "resume/summary/" + profile_id}
                      >
                        <BiPencil
                          size={30}
                          className="text-slate-900 hover:text-[#0072b1] p-1"
                      ...
                      <BiSolidTrash
                        onClick={(e) => delete_summary(summary.id)}
                        size={30}
                        className="text-slate-900 hover:text-[#0072b1] p-1"
                      />
                    </div>
          ...
          <DragDropContext onDragEnd={onDragEnd}>
            <Droppable droppableId="resume" direction="vertical" type="section">
              {(provided) => (
                <ul
                                ...
                                >
                                  ...
                                  <div className="flex justify-start items-center flex-wrap px-2 py-4">
                                    <h1
                                      className={
                                        heading_font_style
                                          ? heading_font_style + " py-2 w-full "
                                          : "font_1" + " py-2 w-full "
                                      }
                                      style={{
                                        fontSize: heading_font_size
                        ...
                        <Draggable key={item} draggableId={item} index={idx}>
                          {(provided) => (
                            <li
                              ...
                              {...provided.draggableProps}
                              {...provided.dragHandleProps}
                              className="hover:bg-emerald-100 hover:cursor-grab"
                            >
                              {experiences && Number(experiences.length) !== 0
                                ? experiences?.map(
                                        ...
                                        <div
                                          className={
                                            certificate.description
                                              ? "w-[70%] border-l-2 border-[#111]"
                                              : "w-[70%]"
                                          }
                                        >
                                          <p
                                            className="font_2 p-4 w-full"
                                            style={{
                                              fontSize: paragraph_font_size
                                                ? paragraph_font_size + "px"
                                                : "14" + "px",
                                    ...
                                    >
                                      ...
                                      >
                                        <div className="hidden dd_menu4 absolute right-0 ">
                                          ...
                                          <BiSolidTrash
                                            onClick={(e) =>
                                              delete_references(references.id)
                                            }
                                            size={30}
                                            className="text-slate-900 hover:text-[#0072b1] p-1"
                                          />
                          ...
                          {(provided) => (
                            ...
                            >
                              ...
                              {custom_section &&
                                ...
                                ? custom_section?.map(
                                  (custom_section, index_custom_section) => (
                                    <div
                                ...
                                <section className="justify-center items-center p-4">
                                  <div
                                    className={
                                      paragraph_font_style
                                        ? paragraph_font_style +
                                        " flex flex-wrap items-center justify-start mt-2"
                                        : "font_2" +
                                        " flex flex-wrap items-center justify-start mt-2"
                                    }
                                    style={{
                                  ...
                                  >
                                    <FaEnvelope />
                                    <p className="pl-4 w-80 break-words">
          ...
          {digital_signature && digital_signature != "" ? (
            <div
              className={
                Number(props.formatting) === 1
                  ? "dd_btn4 hover:bg-emerald-100 cursor-pointer relative px-4"
                  : "px-10"
              }
            >
              <div className="hidden dd_menu4 absolute right-0 top-0">
                ...
                <a
                  href={
                    global.localPath + "resume/digital-signature/" + profile_id
                  }
                >
                  <BiPencil
                    size={30}
