...
import { BiCamera, BiPencil, BiSolidTrash, BiMove } from "react-icons/bi";
...
const Header = (props) => {
  ...
  return (
    <section
      id={"print-content-8_" + props.doc_id}
      style={{
        transform: scale,
        width: width + "%",
        ...
        >
          ...
          >
            ...
            >
              ...
              <div className="flex justify-start items-start flex-wrap w-[70%] p-4">
                <h1
                  className={
                    heading_font_style
              ...
              <div className="flex items-center justify-end w-[30%] p-4">
                {personal_info.profile_image ? (
                  <img
                    src={global.imageUrl + "/" + personal_info.profile_image}
                    width={120}
                    height={120}
                    className="rounded-lg w-[120px] h-[120px] shadow-lg border-2 border-[#111]"
                  />
                ) : (
                  <div
                    className={
                      heading_font_style
                        ? heading_font_style +
                        " rounded-lg w-[120px] h-[120px]  flex justify-center items-center"
                        : "font_1" +
                        " rounded-lg w-[120px] h-[120px]  flex justify-center items-center"
                    }
                    style={{
              ...
              <div className="col-span-5 w-full">
                <section className=" justify-center items-center p-4 bg-slate-800">
                  <div
                    className={
                      paragraph_font_style
                        ? paragraph_font_style +
                  ...
                  {personal_info.linkedin ? (
                    ...
                    >
                      <FaLinkedin className="text-white text-xl mr-2" />
                        ...
                        <Draggable key={item} draggableId={item} index={idx}>
                          {(provided) => (
                            <li
                              ...
                              className="hover:bg-emerald-100 hover:cursor-grab w-[50%] border-b border-b-slate-300"
                            >
                              <>
                                <div
                                  className={
                                ...
                                ? experiences?.map(
                                  (experiences, index_experiences) => (
                                    <div
                                      ...
                                      className="flex justify-start items-center flex-wrap px-10 py-4"
                                    >
                              ...
                              {technical_skills && technical_skills != "" ? (
                                <>
                                  ...
                                  >
                                    ...
                                    <div className="flex justify-center items-center flex-wrap px-10 py-4">
                                      <h1
                                        className={
                                          heading_font_style
                                            ? heading_font_style +
                                ...
                                ? certificate.map(
                                  (certificate, index_certificate) => (
                                    <div
                                      ...
                                      className="flex justify-center items-center flex-wrap px-10 py-4"
                                    >
                        ...
                        <Draggable key={item} draggableId={item} index={idx}>
                          {(provided) => (
                            <li
                              ...
                              {...provided.draggableProps}
                              {...provided.dragHandleProps}
                              className="hover:bg-emerald-100 hover:cursor-grab w-[50%]"
                            >
                              ...
                              {languages && Number(languages.length) > 0
                                ? languages.map(
                                  (languages, index_languages) => (
                                    <div
                                      key={index_languages}
                                      className="flex justify-center items-center flex-wrap px-10"
                                    >
