...
const Header = (props) => {
  ...
  return (
    <section
      id={"print-content-6_" + props.doc_id}
      style={{
        transform: scale,
        width: width + "%",
    ...
    >
      {check_loading === 0 ||
        ...
        >
          <div
            className="text-white p-5 rounded-t-md"
          ...
          >
            ...
            >
              <div className="flex flex-wrap justify-center items-center">
                ...
                <div className="flex justify-center items-center flex-wrap w-full text-center text-white">
                  <h1
                    className={
                      heading_font_style
          ...
          <div className="flex justify-evenly items-start w-full py-4">
            <div className="w-[48%] border-2 border-slate-300 p-2 rounded-lg">
            ...
            <div className="w-[48%] border-2 border-slate-300 p-2 rounded-lg ">
              <section className=" justify-center items-center py-10">
                ...
                >
                  <div className="p-1 rounded-full border-2 border-slate-300">
                    <FaHome
                      className="text-xl"
