        ...
        <>
          <div className="main flex flex-wrap justify-start items-start h-[100%]">
            <div className="w-[30%] h-[100%] ">
              <div className="bg-[#29292b] py-[100px]">
                <div
                  className={
                ...
                >
                  <div className="hidden dd_menu4 absolute right-0">
                    ...
                    {/* <BiSolidTrash size={30} className='text-white hover:text-[#0072b1] p-1'/> */}
                  </div>
                  <div className="flex flex-wrap justify-center items-center px-4 py-2 w-full">
                    <div className="py-2 text-center">
                      <div className="flex justify-center flex-wrap items-center text-[#fff] text-5xl uppercase py-2">
                        <h1
                          className={
                            heading_font_style
                        ...
                        <p
                          className={
                            paragraph_font_style
                              ? paragraph_font_style +
                              " text-[#fff] uppercase text-2xl font-light tracking-widest py-2"
                ...
                <div className="mx-6 text-[#2e302e] mt-10 mb-4">
                  <div className="flex items-center justify-start">
                    <h2 className="uppercase text-[#fff] py-2 mb-4 text-2xl ubuntu tracking-widest w-full border-b-2 border-b-solid border-b-white">
                      Contacts
                    </h2>
                  </div>
                  {personal_info.gender ? (
                    <div className="py-1 flex justify-start items-center">
                      <div className="bg-white text-[#2e302e] w-[30px] h-[30px] flex justify-center items-center rounded-full">
                        <BiSolidUser size={20} />
                      </div>
                      ...
                      <p
                        className={
                          paragraph_font_style
                            ? paragraph_font_style + " pl-4 text-white"
                            : " ubuntu pl-4 text-lg text-white"
                        }
                        style={{
                  ...
                  {props.runtime_street_address ||
                    ...
                    <div className="py-1 flex justify-start items-center ">
                      ...
                      <p
                        className={
                          paragraph_font_style
                            ? paragraph_font_style + " pl-4 w-[80%] text-white"
                            : " ubuntu pl-4 text-lg w-[80%] text-white"
                        }
                        style={{
                          fontSize: paragraph_font_size
                            ? paragraph_font_size + "px"
                                              ...
                                              >
                                                <div className="hidden dd_menu4 absolute right-0 ">
                                                  ...
                                                  >
                                                    <BiPencil
                                                      size={30}
                                                      className="text-white hover:text-[#0072b1] p-1"
                                                    />
                                                  </a>
                                                  <BiSolidTrash
                                                    onClick={(e) =>
                                                    ...
                                                    size={30}
                                                    className="text-white hover:text-[#0072b1] p-1 cursor-pointer"
                                                  />
                                                </div>
                                      ...
                                      ? awards.map((awards, index_awards) => (
                                        ...
                                        >
                                          {Number(index_awards) === 0 ? (
                                            <div className="flex items-center justify-center mx-4 mt-4 py-4 text-[#fff] border-t-2 border-[#fff]">
                                              <div className="w-[40px] h-[40px] flex items-center justify-center rounded-full bg-[#fff] text-white">
                                                <FaTrophy size={25} />
                                              </div>
                                              <h2
                                                className={
                                                  heading_font_style
                                                    ? heading_font_style +
                                                    " uppercase text-[#fff] ml-2 text-2xl font-bold"
                                                    : "uppercase text-[#fff] ml-2 text-2xl font-bold ubuntu"
                                                }
                                                style={{
                                                  fontSize: heading_font_size
                                                    ? heading_font_size + "px"
                                    ...
                                    ? languages.map(
                                      (languages, index_languages) => (
                                        ...
                                        >
                                          ...
                                          >
                                            <div className="hidden dd_menu4 absolute right-0 top-0">
                                              {/* <BiMove size={30} className='text-white hover:text-[#0072b1] p-1'/> */}
                                              <a
                                                href={
                                                  global.localPath +
                                                  "resume/languages/" +
