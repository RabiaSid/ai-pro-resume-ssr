...
const Header = (props) => {
  ...
  return (
    <section
      id={"print-content-10_" + props.doc_id}
      style={{
        transform: scale,
        width: width + "%",
        ...
        >
          ...
          >
            <div className="flex flex-wrap justify-center items-center">
              ...
              <div className="flex items-center text-center w-[20%]">
                {personal_info.profile_image ? (
                  <img
                    ...
                    width={120}
                    height={120}
                    className="rounded-lg m-auto w-[120px] h-[120px] shadow-lg "
                  />
                ) : (
                  <div
                    className={
                      heading_font_style
                        ? heading_font_style +
                        " rounded-lg w-[120px] h-[120px] m-auto flex justify-center items-center"
                        : "font_1" +
                        " rounded-lg w-[120px] h-[120px] m-auto flex justify-center items-center"
                    }
                    style={{
              ...
              <div className="flex justify-start items-center flex-wrap w-[30%]">
                <h1
                  className={
                    heading_font_style
          ...
          <DragDropContext onDragEnd={onDragEnd}>
            <Droppable droppableId="resume" direction="both" type="section">
              {(provided) => (
                <ul
                        ...
                        <Draggable key={item} draggableId={item} index={idx}>
                          {(provided) => (
                            <li
                              ...
                              className="hover:bg-emerald-100 hover:cursor-grab w-[30%] text-white"
                        ...
                        <Draggable key={item} draggableId={item} index={idx}>
                          {(provided) => (
                            <li
                              ...
                              {...provided.draggableProps}
                              {...provided.dragHandleProps}
                              className="hover:bg-emerald-100 hover:cursor-grab w-[30%]"
                            >
          ...
          {digital_signature && digital_signature != "" ? (
            <div
              className={
                Number(props.formatting) === 1
                  ? "dd_btn4 hover:bg-emerald-100 cursor-pointer relative px-2"
                  : "px-2"
              }
            >
              <div className="hidden dd_menu4 absolute right-0 top-0">
