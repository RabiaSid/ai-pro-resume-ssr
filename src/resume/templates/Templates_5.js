...
const Header = (props) => {
      ...
      .then((data) => {
        if (data) {
          ...
          if (props.pen_color != "d") {
            ...
            setpen_color_def("darkTurquoise");
          } else {
            setpen_color_def(
              props.pen_color ? props.pen_color : data.data.data.color
            );
  ...
  return (
    <section
      id={"print-content-5_" + props.doc_id}
      style={{
        transform: scale,
        width: width + "%",
            ...
            <div className="flex flex-wrap justify-center items-center text-black">
              ...
              <div className="col-span-5 w-[50%]">
                <section className=" justify-center items-center py-10">
                  ...
                  >
                    <FaEnvelope style={{ color: pen_color_def }} />
                    <p className="pl-2 w-80 break-words">
                  ...
                  {props.runtime_phone_number ||
                    ...
                    >
                      <FaPhone style={{ color: pen_color_def }} />
                      <p className="pl-2 w-80 break-words">
                        {props.runtime_phone_number
                          ? props.runtime_phone_number
                          : personal_info.phone_number
                  ...
                  {personal_info.linkedin ? (
                    ...
                    >
                      <FaLinkedin style={{ color: pen_color_def }} />
                                    ...
                                    <>
                                      ...
                                      >
                                        ...
                                        <div className="flex justify-center items-center flex-wrap px-2 py-4">
                                          <hr className="border-t-1 border-black  flex-grow w-full"></hr>
                                          ...
                                          <hr className="border-t-1 border-black w-full flex-grow"></hr>
                                        ...
                                        >
                                          ...
                                          >
                                            ...
                                            <>
                                              ...
                                              <div className="flex items-center justify-start text-black w-full">
                                                {/* <div className='rounded-full  flex  items-center w-[40px] h-[40px]'>
              <BiCommentDetail  className='mr-4' style={{'fontSize': heading_font_size ? heading_font_size+'px' : '30'+'px','color':pen_color_def}} />
              </div> */}
                                                <h2
                                                  className={
                                                    heading_font_style
                                            ...
                                            <div className="flex justify-center items-center flex-wrap text-slate-900">
                                              <p
                                                className={
                                                  paragraph_font_style
                                                    ? paragraph_font_style +
