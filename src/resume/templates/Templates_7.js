...
const Header = (props) => {
  ...
  return (
    <section
      id={"print-content-7_" + props.doc_id}
      style={{
        transform: scale,
        width: width + "%",
      ...
      {check_loading === 0 ||
        ...
        >
          <div className="flex justify-evenly items-start w-full py-4">
            <div className="w-[59%] p-2">
              ...
              >
                <div className="flex flex-wrap justify-center items-center text-black">
                  ...
                  <div className="flex items-center text-center w-[20%]">
                    {personal_info.profile_image ? (
                      <img
                        ...
                        width={120}
                        height={120}
                        className="rounded-lg m-auto w-[120px] h-[120px] border-4 border-[#111]"
                      />
                    ) : (
                      <div
                        className={
                  ...
                  <div className="flex justify-center items-center flex-wrap w-[80%] text-center">
                    <h1
                      className={
                        heading_font_style
                            ...
                            >
                              {(provided) => (
                                <li
                                  ...
                                  style={{ marginTop: section_spacing + "px" }}
                                >
                                  {experiences &&
                                      ...
                                      (experiences, index_experiences) => (
                                        ...
                                        >
                                          {Number(index_experiences) === 0 ? (
                                            <>
                                              <div className="flex items-center justify-start text-black w-full">
                                                <div
                                                  className="p-2 mr-4"
                                                  style={{
            ...
            <div className="w-[39%] p-2 ">
              <section
                className=" justify-center items-center p-4 text-white rounded-xl"
              ...
              >
                ...
                >
                  ...
                  <p className="pl-2 w-full break-words">
                    {" "}
                    <i>
                            ...
                            >
                              {(provided) => (
                                <li
                                  ...
                                  {...provided.draggableProps}
                                  {...provided.dragHandleProps}
                                  className="hover:bg-emerald-100 hover:cursor-grab rounded-xl"
                                  style={{
                                    marginTop: section_spacing + "px",
                                    background: pen_color_def,
                                  }}
                                  ...
                                  {education && Number(education.length) !== 0
                                    ? education?.map(
                                      (education, index_education) => (
                                        <div
                                          key={index_education}
                                          className="flex justify-start items-center flex-wrap px-2 py-4 text-white"
                                        >
                                          {Number(index_education) === 0 ? (
                                            <>
                                              <div className="flex items-center justify-start text-white w-full">
                                                <div className="rounded-full  flex  items-center w-[40px] h-[40px]">
                                                  <FaBook
                                                    className="mr-4"
                                                    style={{
                                                      fontSize:
                                  ...
                                  {soft_skills && soft_skills != "" ? (
                                    <>
                                      <div
                                        className={
                                          Number(props.formatting) === 1
                                            ? "dd_btn4 hover:bg-emerald-100 relative text-white"
                                            : "text-white"
                                        }
                                      >
                                        <div className="hidden dd_menu4 absolute right-0 top-0">
                                    ...
                                    ? awards.map((awards, index_awards) => (
                                      ...
                                      >
                                        ...
                                        <div
                                          className={
                                            Number(props.formatting) === 1
                                              ? "dd_btn4  relative w-full flex justify-center items-center flex-wrap text-white"
                                              : "text-white"
                                          }
                                        >
                                          <div className="hidden dd_menu4 absolute right-0 top-0">
