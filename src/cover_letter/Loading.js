...
const Header = ({ isOpen }) => {
  ...
  useEffect(() => {
    ...
    setTimeout(function () {
      window.location.href = global.localPath + "cover-letter/choose-template";
    }, 3500);
      ...
      <div id='main_contents' className='lg:w-[100%] lg:ml-[0%]'>
        <section className='flex justify-between items-start lg:w-[90%] m-auto flex-wrap'>
          ...
          <div className='flex justify-between items-start lg:w-[550px] m-auto flex-wrap mt-[10%] p-4'>
            ...
            <h1 className='font_1 text-slate-900 text-4xl mt-8 w-full text-center animate-pulse'>COVER LETTER LOADING...</h1>
            <h1 id='load_1' className='hidden font_1 text-slate-900 text-md md:text-2xl mt-8 w-full justify-start items-center'><BiCheck className='bg-[#0072b1] text-white text-lg md:text-2xl rounded-md mr-2' /> 10+ PROFESSIONAL COVER LETTER</h1>
            ...
            <h1 id='load_3' className='hidden font_1 text-slate-900 text-md md:text-2xl mt-8 w-full justify-start items-center'><BiCheck className='bg-[#0072b1] text-white text-lg md:text-2xl rounded-md mr-2' /> 1100+ JOB TITLES</h1>
