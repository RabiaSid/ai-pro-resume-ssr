...
const Header = (props) => {
  ...
  return (
    <section
      id={"print-content-6_" + props.doc_cover_id}
      style={{
        transform: scale,
        width: width + "%",
    ...
    >
      {check_loading === 0 ? (
        ...
        >
          <div
            className="flex flex-wrap items-center justify-evenly  text-white shadow"
          ...
          >
            ...
            <div className="w-[50%] col-span-6 text-right">
              <section className=" flex flex-wrap justify-center items-center">
                <div className="flex items-center flex-wrap justify-start mt-2 w-full">
                ...
                <div className="flex items-center justify-start mt-2 mr-4 w-full">
        ...
        {props.runtime_closer_descriptions ? props.runtime_closer_descriptions : cover_letter.closer_detail ? cover_letter.closer_detail : ''}
          ...
          <div className="h-[10px]" style={{ background: pen_color_def }}></div>
          <div
            className="opacity-70 h-[30px]"
            style={{ background: pen_color_def }}
          ></div>
