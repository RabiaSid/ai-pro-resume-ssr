        ...
        <div className="flex flex-col flex-1">
            ...
            <div className="flex justify-between items-center">
              <div className="">
                <h2
                  ...
                  className="text-[black] Roboto uppercase text-5xl heading data-font-name font-bold p-2"
                >
                ...
                <div className={`w-full`}>
                  <div className="bg-[#288057d5] w-full h-3 mb-4 data-shapes-inner"></div>
                </div>
                <p className="text-[black] Roboto tracking-wider capitalize text-lg sub_heading  font-bold">
                  {job_title ? job_title : "Your Role/Job Position"}
                </p>
              </div>
              <div className="w-[30%]">
                <p className="text-[black] text-center Roboto text-md flex items-center sub_heading mb-4 flex-shrink-0">
                  <FiPhone
                    size={16}
                ...
                <p className="text-[black] Roboto text-md flex items-center sub_heading flex-shrink-0 mb-4">
                  <LuMail
                    size={16}
                    className="mr-2 text-[black] min-w-[16px]"
                  />
          ...
          <div className="flex justify-between items-start flex-wrap mt-10 px-16 w-full">
            ...
            <div className="w-[30%] resume-section-content">
              <p className="text-[black] Roboto text-base data-font-name font-bold mb-4">
                {formattedDate(date)}
              </p>
              <p className="text-[black] Roboto text-base data-font-name flex justify-start items-center mb-4">
              ...
              <p className="text-[black] Roboto text-base data-font-name flex justify-start items-center mb-4">
                <LuMail
                  size={16}
                  className="text-[black] mr-2 min-w-[16px] flex-shrink-0"
                />
              ...
              <p className="text-[black] Roboto text-base data-font-name flex justify-start items-center">
                <RiHome2Line
                  size={16}
                  className="text-[black] mr-2 min-w-[16px] flex-shrink-0"
                />
          ...
          {/* Signature */}
          <div className="flex  Roboto gap-2 flex-col py-8 px-16 w-full data-font-name">
            <span> Sincerely,</span>
            {signature ? (
