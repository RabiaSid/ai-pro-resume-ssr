  ...
  return (
    ...
    >
      <div className="flex flex-wrap justify-start items-start w-full">
        {/* header  */}
        <div className="h-[20px] w-full bg-[#180245] border-b border-solid border-[#330E7D] data-shapes-main data-headings-border"></div>
        <div className="bg-[#180245] flex justify-center items-center w-full data-shapes-main">
          <div
            className="flex justify-center items-start flex-wrap py-10 px-16 w-[70%]"
            id="data_profile"
          >
            <h2 className="text-[#fff] Almarai uppercase font-bold text-3xl w-full heading data-font-name">
              {first_name ? first_name : "Your Name"}{" "}
              {last_name ? last_name : ""}
            </h2>
            <p className="text-[#fff] Almarai tracking-wider uppercase text-sm w-full sub_heading data-font-name">
              {job_title ? job_title : "Your Role/Job Postion"}
            </p>
          </div>

          <div
            className="flex justify-between items-center flex-wrap my-8 px-4 w-[40%] border-l border-solid border-[#330E7D]  data-headings-border"
            id="data_contacts"
          >
            <p className="text-[#fff] Almarai text-sm w-full flex items-center py-2 sub_heading data-font-name">
            ...
            {street_address ||
              ...
              allCountries.find((con) => con.id === country_id)?.name !==
                ...
                <p className="text-[#fff] Almarai text-sm w-full flex items-center py-2 sub_heading data-font-name ">
                  ...
                  <div className="break-words whitespace-pre-wrap w-[90%]">
                    <>
        ...
        <div className="h-[20px] w-full bg-[#180245] border-t border-solid border-[#330E7D] data-shapes-main data-headings-border"></div>
        {/* end header  */}
        {show_personal_information ? (
          <>
            {/* opener  */}
            <div
              ...
              id="data_opener"
            >
              <p className="text-[#180245] Almarai text-md w-full font-bold data-font-name resume-section-content">
                {formattedDate(date)}
              </p>
              <p className="text-[#000000] Almarai text-base w-full mt-8 data-font-name resume-section-content ">
                Dear{" "}
                <b> {contact_person_name ? contact_person_name : "John Doe"}</b>
              </p>

              <p className="text-[#000000] Almarai text-base w-full data-font-name resume-section-content">
                {contact_person_designation
                  ? contact_person_designation
          ...
          <>
            <div
              className="flex justify-start items-start flex-wrap mt-10 px-20 w-full resume-section-content"
              id="data_opener"
            >
              <p className="text-[#180245] Almarai text-md w-full font-bold data-font-name">
                {formattedDate(date)}
              </p>
              <p className="text-[#000000] Almarai text-base w-full mt-8 data-font-name">
                Dear HR Manager
              </p>
            </div>
          </>
        ...
        <div
          className="flex flex-col gap-4 mt-6 px-20 w-full data-font-name resume-section-content "
          id="data_body"
        >
          <p className="text-[#000000] Almarai resume-section-content text-justify leading-5 text-base w-full whitespace-pre-line data-font-name">
            {experience < 1
          ...
          <p
            className="text-[#000000] Almarai resume-section-content text-justify leading-5 text-base w-full whitespace-pre-line data-font-name"
        ...
        <div
          ...
          id="data_closer"
        >
          <span className="text-[#000] Almarai tracking-wider capitalize text-base w-full data-font-name">
            Sincerely.
          </span>
      ...
      <div className="h-[30px] w-full bg-[#180245] absolute bottom-0 data-shapes-main"></div>
    </section>
  );
};
