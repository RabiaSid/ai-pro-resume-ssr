...
const Header = ({
  ...
  return (
    ...
    >
      <div className="chk_height flex flex-col h-full min-h-[1308px] w-full border-l-[80px] border-[#aa7a5b] data-headings-border">
        {/* Content */}
        ...
        <div className="flex flex-col flex-1 text-left">
            ...
            <div className="flex justify-between items-center">
              <div>
                <h2
                  ...
                  className="text-[black] Lato  text-5xl heading data-font-name font-bold pr-3"
                >
                  {first_name ? first_name : "Your Name"}{" "}
                  {last_name ? last_name : ""}
                </h2>

                <p className="text-[black] Lato tracking-wider  text-lg sub_heading  data-font-name font-bold">
                  {job_title ? job_title : "Your Role/Job Position"}
                </p>
              </div>
              <div className="w-[30%]">
                <p className="text-[black] text-center Lato text-md flex items-center data-font-name sub_heading mb-4">
                  <FiPhone
                    size={16}
                ...
                <p className="text-[black] Lato text-md flex items-center data-font-name sub_heading mb-4">
                  <LuMail
                    size={16}
          ...
          <br></br>
          {/* Signature */}
          <div className="flex Lato gap-2 flex-col  px-16 w-full data-font-name">
            <span> Sincerely,</span>
            {signature ? (
