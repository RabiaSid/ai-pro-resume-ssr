...
const Header = ({
  ...
  return (
    ...
    >
      <div className="chk_height flex flex-col h-full min-h-[1308px] w-full border-t-[40px] border-[black]">
        {/* Content */}
        <div
          style={{
            "clip-path": "inset(5% 0 68% 0)",
          }}
          className="bg-[#21219b] w-[300px] h-[150px] absolute left-[50px] top-[20px] data-shapes-inner"
          data-headings-main
        ></div>
        <div className="flex flex-col flex-1 text-left ">
            ...
            <div className="flex justify-between items-center">
              <div>
                <h2
                  ...
                  className="text-[#21219b] Roboto  text-5xl heading data-font-name font-bold data-headings-third pr-3"
                >
                  {first_name ? first_name : "Your Name"}{" "}
                  {last_name ? last_name : ""}
                </h2>

                <p className="text-[black] Roboto tracking-wider  text-lg sub_heading  ">
                  {job_title ? job_title : "Your Role/Job Position"}
                </p>
              </div>
              <div className="w-[30%]">
                <p className="text-[black] text-center Roboto text-md flex items-center sub_heading mb-4">
                  <FiPhone
                    size={16}
                    className="mr-2 text-[black] min-w-[16px]"
                  />
                  <div className="break-all">
                    {phone_number ? phone_number : "Phone"}
                  </div>
                </p>
                <p className="text-[black] Roboto text-md flex items-center sub_heading mb-4">
                  <LuMail
                    size={16}
                    className="mr-2 text-[black] min-w-[16px]"
                  />
          ...
          <div className="w-full border-t-1 border-b-2 border-solid border-[#443B3B] data-headings-border"></div>
          {/* end header */}

          {/* opener */}
          <div className="flex justify-between items-start flex-wrap mt-10 px-16 w-full">
            <div className="w-[70%] resume-section-content">
              <p className="text-[#21219b] Roboto text-base data-font-name font-bold data-headings-third">
              ...
              <p className="text-[black] Roboto text-base mt-2 data-font-name flex justify-start items-center">
                <FiPhone size={16} className=" text-[black] mr-2" />
                <span>
                  {contact_person_phone
                    ? contact_person_phone
              ...
              <p className="text-[black] Roboto text-base mt-2 data-font-name flex justify-start items-center">
                <LuMail size={16} className=" text-[black] mr-2" />
                {contact_person_email
                  ? contact_person_email
                  : "Contact Person Email"}
              </p>
              <p className="text-[black] Roboto text-base mt-2 data-font-name flex justify-start items-center">
                <RiHome2Line size={16} className=" text-[black] mr-2" />
                {company_address ? company_address : "Company Address"}
              </p>
            </div>

            <div className="w-[30%] resume-section-content text-end">
              <p className="text-[#21219b] Roboto text-base data-font-name font-bold data-headings-third">
                {formattedDate(date)}
              </p>
            </div>
          ...
          <br></br>
          {/* Signature */}
          <div className="flex Roboto gap-2 flex-col  px-16 w-full data-font-name">
            <span> Sincerely,</span>
            {signature ? (
