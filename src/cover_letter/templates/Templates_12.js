  ...
  return (
    ...
    >
      {check_loading === 0 ? (
        ...
        >
          <div className="bg-[#f1f1f1] flex justify-between items-start flex-wrap p-8">
            <div className="">
              <div
              ...
              <div
                className={
                  paragraph_font_style
                    ? paragraph_font_style +
                    " text-[#555] tracking-widest mt-6 italic"
                    : " text-[#555] ubuntu tracking-widest mt-6 italic"
                }
                style={{
                  fontSize: paragraph_font_size
                    ? paragraph_font_size + "px"
            ...
            <div className="">
              <div className="flex items-center justify-end py-2">
                <p
                  className={
                    paragraph_font_style
                      ? paragraph_font_style + " pr-2 text-[#222]"
                      : " pr-2 ubuntu text-[#222]"
                  }
                >
