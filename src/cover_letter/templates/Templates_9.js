...
const Header = (props) => {
  ...
  return (
    <section
      id={"print-content-9_" + props.doc_cover_id}
      style={{
        transform: scale,
        width: width + "%",
      ...
      {check_loading === 0 ? (
        ...
        >
          <div className="flex items-center">
            <div
              className="border-2 h-[50px] w-[30%] text-center py-3 rounded-lg"
              style={{ borderColor: pen_color_def }}
            >
              Cover letter
            </div>
            <hr
              className="border-2  ml-4 flex-grow"
              style={{ borderColor: pen_color_def }}
            />
          </div>
          <div className="grid grid-cols-12 gap-4  text-black mx-2">
            <div className="col-span-4 flex items-center">
              {" "}
              <hr
                className="border-2 border-dashed border-black ml-4 flex-grow"
                style={{ borderColor: pen_color_def }}
              />
            </div>
            <div className="col-span-4 text-center ">
              <h1
                className={
                  heading_font_style
                    ? heading_font_style + " text-center pt-[25px]"
                    : "font_1 font-bold text-center pt-[25px]"
                }
                style={{
              ...
              <p
                className={
                  paragraph_font_style
                    ? paragraph_font_style + " mt-2 mb-4 text-center "
                    : " mt-2 font_2 mb-4 text-center "
                }
                style={{
            ...
            <div className="col-span-4 flex items-center mx-2">
              {" "}
              <hr
                className="border-2 border-dashed ml-4 flex-grow"
                style={{ borderColor: pen_color_def }}
              />
            </div>
          </div>
          <div className="flex flex-wrap justify-between items-center text-black mx-2">
              ...
              <section className="justify-between items-center">
                <div className="flex items-center justify-start mt-2">
                  {props.runtime_streetAddress ||
                    ...
                    <>
                      <FaHome className="text-black text-lg mr-2" />
            ...
            <div className="flex col-span-6 justify-end px-10">
              <section className="justify-center items-center">
                <div className="flex items-center justify-start mt-2 ">
                  {props.runtime_streetAddress ||
                    ...
                    <>
                      <FaHome
                        className="text-white text-2xl mr-2 p-1"
                ...
                <div className="flex items-center justify-start">
                  <FaPhone className="text-black text-lg mr-2" />
