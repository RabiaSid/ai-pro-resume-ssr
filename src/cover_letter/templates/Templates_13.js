  ...
  return (
    ...
    >
      {check_loading === 0 ? (
        ...
        <>
          <div
            className="w-[50%] h-[200px] lg:h-[400px] absolute right-0 bg-image "
            style={{ backgroundColor: pen_color_def }}
          >
            <div className="absolute h-[100%] w-[2px] bg-white left-[-1px]"></div>
            <div className="absolute h-[100%] w-[2px] bg-white right-[-1px]"></div>
            <div className="absolute w-[100%] h-[2px] bg-white top-[-1px]"></div>
            <div className="absolute w-[100%] h-[2px] bg-white bottom-[-1px]"></div>
          </div>
          <div
            className="w-full"
            style={{
          ...
          >
            <div className=" flex justify-between items-start flex-wrap p-8">
              <div className="py-8">
                <div
                  className={heading_font_style ? heading_font_style + "" : ""}
                  style={{
                    color: pen_color_def,
                ...
                <div className="flex items-center justify-start py-2">
                  ...
                  <p
                    className={
                      paragraph_font_style
                        ? paragraph_font_style + " pl-2 text-[#222]"
                        : " pl-2 ubuntu text-[#222]"
                    }
                  >
            ...
            <div className="flex items-start justify-between px-8 flex-wrap">
                ...
                <div className="text-[#222]">
                  <div
                    className={
                      paragraph_font_style
                        ? paragraph_font_style +
                        " text-[#222] tracking-widest mt-6 italic"
                        : " text-[#222] ubuntu tracking-widest mt-6 italic"
                    }
                    style={{
                      fontSize: paragraph_font_size
                        ? paragraph_font_size + "px"
              ...
              <div className="w-full my-14 text-[#222]">
                <p
                  className={
                    ...
                    <div className="flex justify-start items-center flex-wrap py-4">
                      {Number(digital_signature.is_text) === 1 ? (
                        ...
                        >
                          <img
                            src={
                              global.imageUrl + "/" + digital_signature.image
                            }
                            width={100}
                            height={100}
                            className=""
