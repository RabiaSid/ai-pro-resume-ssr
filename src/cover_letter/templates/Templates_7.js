...
const Header = (props) => {
  ...
  return (
    <section
      id={"print-content-7_" + props.doc_cover_id}
      style={{
        transform: scale,
        width: width + "%",
    ...
    >
      {check_loading === 0 ? (
        ...
        >
          ...
          <div className="flex flex-wrap justify-evenly items-center gap-4  text-black">
              ...
              >
                {props.runtime_firstName
                  ...
                  : cover_letter.first_name
                    ? cover_letter.first_name
                    : "First Name"}{" "}
                <span style={{ color: pen_color_def }}>
            ...
            <div className="col-span-4 ">
              <section className="justify-center items-center">
                ...
                <div className="flex items-center justify-start mt-2">
                  ...
                  <p
                    className={
                      "text-black" + paragraph_font_style
                        ? paragraph_font_style
                        : "font_1"
                    }
                    style={{
        ...
        {props.runtime_closer_descriptions ? props.runtime_closer_descriptions : cover_letter.closer_detail ? cover_letter.closer_detail : ''}
          ...
          <div className="h-[30px]" style={{ background: pen_color_def }}></div>
        </div>
      )}
    </section>
  );
