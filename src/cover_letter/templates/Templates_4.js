...
const Header = (props) => {
  ...
  return (
    <section
      id={"print-content-4_" + props.doc_cover_id}
      style={{
        transform: scale,
        width: width + "%",
    ...
    >
      {check_loading === 0 ? (
        ...
        >
          <div className="flex items-center justify-between  text-black mx-2">
          ...
          <div className="grid grid-cols-12 gap-4 text-black mx-2">
            <div className="col-span-6 mx-5">
              <section className="justify-center items-center mb-2">
                <div className="flex items-center justify-start mt-2 text-lg">
