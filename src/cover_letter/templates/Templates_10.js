  ...
  return (
    ...
    >
      {check_loading === 0 ? (
        ...
        >
          <div className="grid grid-cols-12 gap-4 bg-white  text-black ">
            <div
              ...
              <h1
                className={
                  heading_font_style
                    ...
                    : "font_1 font_1 text-left pt-[25px]"
                }
                style={{
          ...
          <section className="text-gray-800 text-justify my-10">
            <p
            ...
            <p
              className={
                paragraph_font_style
                  ? paragraph_font_style + " font-bold mb-2"
                  : "font_1 font-bold mb-2"
              }
              style={{
                marginTop: section_spacing + "px",
                fontSize: paragraph_font_size
            ...
            >
              ...
              {props.runtime_opener_experience === 0 ||
                ...
                ? "Fresh"
                : props.runtime_opener_experience <= 1
                  ? props.runtime_opener_experience + " Year"
                  : props.runtime_opener_experience > 10
                    ? "10+ Years"
                    : props.runtime_opener_experience
                      ? props.runtime_opener_experience + " Years"
                      : cover_letter.experience === 0 ||
                        cover_letter.experience === ""
                        ? "Fresh"
                        : cover_letter.experience <= 1
                          ? cover_letter.experience + " Year"
                          : cover_letter.experience > 10
                            ? "10+ Years"
                            : cover_letter.experience
                              ? cover_letter.experience + " Years"
                              : ""}
            </p>
