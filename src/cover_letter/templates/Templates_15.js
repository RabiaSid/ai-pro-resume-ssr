...
const Header = (props) => {
  ...
  return (
    <section
      ...
      className={"font_1 min-h-[800px] bg-white h-[100%] relative mine_adjust"}
    >
      {check_loading === 0 ? (
        <div className="mt-[10%]">
        ...
        <>
          ...
          >
            <div className="flex justify-center items-start flex-wrap ">
              <div
                className="w-[30%] border-r-2 border-[DeepPink] pt-16"
                style={{ borderColor: pen_color_def }}
              >
                <div className="w-full flex items-center justify-right flex-wrap relative top-[100px] right-[-22px]">
                  <h1
                    className={
                      paragraph_font_style
                        ? paragraph_font_style +
                        " text-[#000] text-right w-full p-2 text-2xl mb-6 tracking-wider font-bold relative right-[40px]"
                        : " text-[#000] text-right w-full p-2 text-2xl mb-6 trebuchet_ms tracking-wider font-bold relative right-[40px]"
                    }
                  >
                    CONTACT
                  </h1>
                  <div className="flex items-center justify-end p-2 w-full">
                    <p
                      className={
                        paragraph_font_style
                          ? paragraph_font_style + " pr-2 text-[#000]"
                          : " pr-2 trebuchet_ms text-[#000]"
                      }
                    >
                    ...
                    <div
                      className="w-[25px] h-[25px] flex items-center justify-center bg-[DeepPink] rounded-full"
              ...
              <div className="flex justify-start items-start flex-wrap w-[70%]">
                <div className="w-full px-8 py-16">
                  <div
                    className={
                      heading_font_style
                        ? heading_font_style + " tracking-widest uppercase"
                  ...
                  <div
                    className={
                      paragraph_font_style
                        ? paragraph_font_style + " tracking-widest mt-2 mb-4 "
                        : " tracking-widest mt-2 mb-4"
                    }
                    style={{
                  ...
                  <div
                    className={
                      paragraph_font_style
                        ? paragraph_font_style +
                        " text-slate-500 tracking-widest italic"
                        : " text-slate-500 bodoni_mt tracking-widest italic"
                    }
                    style={{
                      fontSize: paragraph_font_size
                        ? paragraph_font_size + "px"
                  ...
                  <div className="flex items-center justify-between mt-8 ml-16 w-full">
                    <div className="text-[#000] text-lg">
                      <p
                        className={
                          paragraph_font_style
                            ? paragraph_font_style + " font-bold mb-4"
                            : " trebuchet_ms font-bold mb-4"
                        }
                      >
                        TO HIRING MANAGER
                      </p>
                        ...
                        <div className="">
                          ...
                          >
                            ...
                            {countries
                              .filter(
                                (countries) =>
                                  countries.id === cover_letter.country_id
                              )
                              .map((country) => (
                                <>
                                  {props.runtime_streetAddress ||
                ...
                <div className="flex items-start justify-between  flex-wrap">
                  <div className="w-full my-14 text-[#000] text-lg">
                    <p
                      className={
                        paragraph_font_style
                          ? paragraph_font_style + ""
