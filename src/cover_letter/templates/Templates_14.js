      ...
      .then((data) => {
        if (data) {
          ...
          if (props.pen_color != "d") {
            ...
            setpen_color_def("DarkOliveGreen");
          } else {
            setpen_color_def(
              props.pen_color ? props.pen_color : data.data.data.color
            );
    ...
    >
      {check_loading === 0 ? (
        ...
        <>
          ...
          >
            <div className=" flex justify-center items-start flex-wrap p-8">
              <div className="w-full">
                ...
                <div
                  className={
                    paragraph_font_style
                      ? paragraph_font_style +
                      " tracking-widest mt-2 mb-4 text-center"
                      : " tracking-widest text-center mt-2 mb-4"
                  }
                  style={{
                ...
                <div className="w-full flex items-center justify-center border-t-2 border-b-2 border-black">
                  <div className="flex items-center justify-start p-2">
                    <FaPhone
                      className="text-[DarkOliveGreen]"
                      size={14}
                ...
                <div className="text-[#222]">
                  <div
                    className={
                      paragraph_font_style
                        ? paragraph_font_style +
                        " text-[#222] tracking-widest py-4 italic"
                        : " text-[#222] bodoni_mt tracking-widest py-6 italic"
                    }
                    style={{
                      fontSize: paragraph_font_size
                        ? paragraph_font_size + "px"
