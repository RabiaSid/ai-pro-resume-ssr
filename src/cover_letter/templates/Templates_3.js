...
const Header = (props) => {
  ...
  return (
    <section
      id={"print-content-3_" + props.doc_cover_id}
      style={{
        transform: scale,
        width: width + "%",
            ...
            <div className=" text-black">
              <div className="my-3">
                <h1
                  className={
                    heading_font_style
                      ? heading_font_style + " text-left pt-[25px]"
                      : "font_1 font-bold text-left pt-[25px]"
                  }
                  style={{
                ...
                <p
                  className={
                    paragraph_font_style
                      ? paragraph_font_style + " mt-2 mb-4 text-left "
                      : " mt-2 font_2 mb-4 text-left "
                  }
                  style={{
              ...
              <div
                className="grid grid-cols-12 gap-4 text-black my-5"
                style={{ background: pen_color_def }}
              >
                <div className="col-span-6 mx-2 my-5">
                  <section className="justify-center items-center">
                    <div className="flex items-center justify-start text-white mt-2 ">
