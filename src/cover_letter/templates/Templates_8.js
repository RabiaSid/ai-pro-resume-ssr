...
const Header = (props) => {
      ...
      .then((data) => {
        if (data) {
          ...
          if (props.pen_color != "d") {
            ...
            setpen_color_def("palevioletred");
          } else {
            setpen_color_def(
              props.pen_color ? props.pen_color : data.data.data.color
            );
  ...
  return (
    <section
      id={"print-content-8_" + props.doc_cover_id}
      style={{
        transform: scale,
        width: width + "%",
      ...
      {check_loading === 0 ? (
        ...
        >
          <div className="flex items-center">
            <div
              className=" text-2xl border-2  h-[50px] w-[30%] text-center py-2 rounded-lg font_1 "
              style={{ color: pen_color_def, borderColor: pen_color_def }}
            >
              Cover letter
            </div>
            <hr
              className="border-4  ml-4 flex-grow"
          ...
          <div className=" bg-white  text-black ml-5">
            ...
            <section className="mb-8 justify-center items-center">
              <div className="flex items-center justify-center mt-2 ml-8">
                <div className="flex items-center justify-center mt-2 ml-8">
                  ...
                  <div
                    className="rounded-full bg-white flex justify-center items-center w-[30px] h-[30px]"
