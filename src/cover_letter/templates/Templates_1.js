...
const Header = (props) => {
  ...
  return (
    <section
      id={"print-content-1_" + props.doc_cover_id}
      style={{
        transform: scale,
        width: width + "%",
      ...
      {check_loading === 0 ? (
        ...
        >
          <div className=" bg-white  text-black ">
            <div className=" text-black mx-4 my-3">
              <h1
                className={
                  heading_font_style
            ...
            <div
              className="flex justify-between items-center text-white py-2 px-2"
          ...
          <section className="text-gray-800 text-justify my-10 px-2">
            ...
            <h2
              className={
                paragraph_font_style
                  ? paragraph_font_style + " font_1 mb-2"
